<?php
mysql_connect("localhost:4000","root","") or die ("could not connect");
...
.flex-item {
  ...
  #header {
	...
	background-image:url(blood_t.jpeg);
    color:white;
    text-align:center;
    padding:5px;
	}
...
<div class="clearfix" style="background-image: url(blood_t.jpeg);background-size:100% 100%;background-repeat:no-repeat;height:150px;" id='header'>
&nbsp;&nbsp;&nbsp;<a href='signup.php'><button type="button" class="btn btn-danger" align="right" style="float:right">Sign Up</button></a> 
<a href='logins.php'><button type="button" class="btn btn-danger" align="right" style="float:right">To Donate Login</button></a> 
<a href='admin1.php'><button type="button" class="btn btn-danger" align="right" style="float:right">Admin Login</button></a> 

</div>
<marquee scrollamount=10 onmouseover="this.stop()"; onmouseout= "this.start()" >
<b><i>Urgently Need O+ Blood.Any One Interested Contact +91 7060975380.</b></i>
</marquee>
  ...
  <div class="container-fluid">
    ...
    <div>
      <ul class="nav navbar-nav">
       ...
       <li><a href="fact.php">Why You Should Donate</a></li>
...
GRAPHIC ERA UNIVERSITY,DEHRADUN<BR>
ONLINE BLOOD BANK MANAGEMENT SYSTEM
</p>
</div>
<p align='right'style="font-family='comic sans ms';color:#eeeeee;" >
FOR FURTHER DETAILS<BR>
CONTACT: DIBYENDU ROY CHAUDHURI<br>
Email:dibyendu830711@geu.ac.in<br>
Phone Number:7060975380
<p>
</div>
</div>
</body>
